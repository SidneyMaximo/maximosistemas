  ...
  return (
    <section id="pricing" ref={ref} className="relative border-t border-[#1e1e1e] bg-[#080808] scroll-mt-[88px]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <div>
            <span className="sys-tag mb-3 block">PREÇOS</span>
            <h2 className="font-display text-6xl lg:text-8xl leading-[0.88] tracking-tight text-[#f2ede6]">
              ESCALE AGENTES.<br />
              <span style={{ WebkitTextStroke: "1px #3a3a3a", color: "transparent" }}>NÃO A SUA CONTA.</span>
            </h2>
          </div>

          {/* Billing toggle */}
          <div className="flex items-center gap-4">
            <span className={`font-mono text-[11px] tracking-widest transition-colors ${!annual ? "text-[#f2ede6]" : "text-[#3a3a3a]"}`}>MENSAL</span>
            <button
            ...
            <span className={`font-mono text-[11px] tracking-widest transition-colors ${annual ? "text-[#f2ede6]" : "text-[#3a3a3a]"}`}>ANUAL</span>
            {annual && (
