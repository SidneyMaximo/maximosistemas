        ...
        <div className="border border-[#1e1e1e] relative overflow-hidden my-12 lg:my-16">
          ...
          <div className="relative z-10 px-8 lg:px-20 py-16 lg:py-24 text-center">
            ...
            <div className="flex items-center justify-center gap-3 mb-10">
              ...
              <span className="font-mono text-[11px] tracking-[0.2em] text-[#22c55e]">RUNTIME JARVIS · PRONTO</span>
            </div>
            ...
            <p className="font-mono text-sm text-[#5a5a5a] mb-12 max-w-lg mx-auto leading-relaxed">
              Join Mais de 4.200 engenheiros publicando fluxos autônomos de IA. O plano gratuito inclui 10 mil ações de agente por mês. Não é necessário cartão de crédito.
            </p>
